                    ...
                    <div class="main-menu">
                        <nav>
                            <ul>
                                ...
                                <li class="menu-item-has-children"><a href="{{asset('/shopgrid')}}">Shop</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children"><a href="{{asset('/shopgrid')}}">shop grid</a>
                                            <ul class="sub-menu">
                                                <li><a href="{{asset('/shopgrid')}}">shop grid</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children"><a href="{{asset('/singleproduct')}}">Single Product</a>
                                            <ul class="sub-menu">
                                                <li><a href="{{asset('/singleproduct')}}">Single Product 1</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
...
<script type="text/javascript" src="{{asset('assets/js/tawk-to.js')}}"></script>
<!--End of Tawk.to Script-->
<!-- Google Analytics -->
<script type="text/javascript" src="{{asset('assets/js/google-analytics.js')}}"></script>
