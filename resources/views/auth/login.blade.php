        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-login">
                    ...
                    <h4>Don’t have account? please click <a href="{{asset('/register')}}">Register</a></h4>
            ...
            <div class="col-md-5 col-12 d-flex">
                ...
                <div class="ee-social-login">
                    ...
                    <a href="{{url('/auth/facebook')}}" class="facebook-login">Login with <i class="fa fa-facebook"></i></a>
                    <a href="{{ url('/auth/twitter') }}" class="twitter-login">Login with <i class="fa fa-twitter"></i></a>
                    <a href="{{url('/auth/google')}}" class="google-plus-login">Login with <i class="fa fa-google-plus"></i></a>
