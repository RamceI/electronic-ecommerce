                ...
                <div class="ee-register">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            <div class="col col-6 p-right">
                                <div class="row">
                                    <div class="col-12  mb-30">
                                        <input id="name" type="text" placeholder="Your name here" class="@error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>
                                    </div>
                                    <div class="col-12 mb-30">
                                        <input id="surname" type="text" placeholder="Your surname here" class="@error('surname') is-invalid @enderror" name="surname" value="{{ old('surname') }}" autocomplete="surname" >
                                    </div>
                                    ...
                                    <div class="col-12 mb-30">
                                        <input id="email" type="email" placeholder="Your email here" class="@error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                                        @error('email')
                            ...
                            <div class="col-12 mb-30">
                                <input id="role" type="hidden" value="0" name="role" >
                            </div>
                    </div>
                    </form>
                </div>
